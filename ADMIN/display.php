...
if(isset($_REQUEST["eventID"]))
{
    ...
    $query ="SELECT eventregistrationtable.eventID,eventmembershiptable.membershipID,meminfotbl.memFName,meminfotbl.memLName,eventregistrationtable.eventName,eventregistrationtable.eventDesc,eventregistrationtable.eventType, eventmembershiptable.membershipStatus,eventregistrationtable.eventDateStart,eventregistrationtable.eventDateEnd FROM eventmembershiptable INNER JOIN meminfotbl ON meminfotbl.memID = eventmembershiptable.memID INNER JOIN eventregistrationtable ON eventregistrationtable.eventID = eventmembershiptable.eventID WHERE eventregistrationtable.eventID = '$eventID' AND eventMembershipTable.membershipStatus = 'ACTIVE';";  
...
<div class="wrapper">
    ...
    <div id="content">
			...
			<div class="container-fluid p-3" style="margin:0px;">
				<div class="container-fluid p-3" style="margin:0px;">
	                <p style="font-size: 30px;margin-top: -30px;">Members Registration</p>
	                        ...
	                        while($row = mysqli_fetch_array($result))  
	                            {  
	                                echo "<tr>";                                    
	                                    ...
	                                    echo "<td class='align-middle'>"; echo $row["membershipStatus"]; echo "</td>";
	                                echo "</tr>";
	                            }  
	                        ?>  
	                    </table>  
