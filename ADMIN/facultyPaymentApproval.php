...
if(isset($_REQUEST["paymentID"]))
{
    ...
    $conn2=mysqli_query($conn ,"SELECT eventregistrationtable.eventID,paymentinfotable.payment,paymentinfotable.memID,paymentinfotable.paymentID,meminfotbl.memFName,meminfotbl.memLName,eventregistrationtable.eventName,eventregistrationtable.eventFree,paymentinfotable.amountPayment,paymentinfotable.paymentStatus,eventregistrationtable.totalContribution FROM paymentinfotable INNER JOIN meminfotbl ON paymentinfotable.memID = meminfotbl.memID INNER JOIN eventregistrationtable ON paymentinfotable.eventID = eventregistrationtable.eventID WHERE paymentinfotable.paymentID = '$paymentID'");
