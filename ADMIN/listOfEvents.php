...
class PDF extends TCPDF
{
    public function Header()
    {
		...
		$this->Ln(40);
		$this->Write(0, 'LIST OF EVENTS', '', 0, 'C', true, 0, false, false, 0);
...
$pdf->Cell(40,5,' Event ID',0,0,'L',1);
$pdf->Cell(62,5,' Event Name',0,0,'L',1);
$pdf->Cell(40,5,' Date Start',0,0,'L',1);
$pdf->Cell(40,5,' Date End',0,0,'L',1);

$query1 = "SELECT eventID,eventName,eventDateStart,eventDateEnd,eventOrganizer FROM eventregistrationtable;";
...
while($row = mysqli_fetch_array($result1)) {
    ...
    $pdf->SetFont('Times','',9);
    $pdf->Cell(40,5,' '. $sID,0,0,'L',1);
    $pdf->Cell(62,5,' '. $eName,0,0,'L',1);
    $pdf->Cell(40,5,' '. $sStart,0,0,'L',1);
    $pdf->Cell(40,5,' '. $sEnd,0,0,'L',1);
    $i++;
}
