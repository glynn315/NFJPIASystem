...
include('../session.php');
$query ="SELECT studentinfotable.studentID,studentinfotable.studentFname,studentinfotable.studentLname,studentinfotable.studentCourse,schoolinfotbl.schoolName,studentinfotable.studentRegion,studentinfotable.studentDateReg,studentinfotable.studentStatus FROM studentinfotable INNER JOIN schoolinfotbl ON studentinfotable.schoolID = schoolinfotbl.schoolID WHERE studentinfotable.studentStatus = 'REGISTERED';";  
						...
						while($row = mysqli_fetch_array($result))  
							{  
								echo "<tr>";									
									...
									echo "<td class='align-middle'>"; echo $row["studentRegion"]; echo "</td>";
