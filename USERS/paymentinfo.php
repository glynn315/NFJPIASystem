  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light border">
    ...
    <div class="p-2 mt-2 center rounded main-Con">
        <div class="container-fluid p-3" style="margin:0px;">
                <p style="font-size: 30px;">PAYMENT INFO</p>
